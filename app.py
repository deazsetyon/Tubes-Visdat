...
if province_filter != "Seluruh Provinsi":
    ...
    st.write("Diagram batang di atas menunjukkan rata-rata pengeluaran per kapita di setiap provinsi di Indonesia. Secara umum, mayoritas provinsi memiliki rata-rata pengeluaran yang berada di kisaran menengah, yaitu sekitar 7.000.000 hingga 12.000.000. Namun, terdapat beberapa provinsi yang menonjol dengan pengeluaran yang lebih tinggi, seperti DKI Jakarta, yang mencatatkan angka di atas 15.000.000. Hal ini mencerminkan adanya disparitas ekonomi antar wilayah, yang dapat diakibatkan oleh perbedaan tingkat pembangunan, pendapatan per kapita, dan akses terhadap layanan publik.")
